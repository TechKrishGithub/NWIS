...
const InspectionOfficerTable = ({wetDetails,rows,setRows}) => {
  ...
  const addRow = () => {
    ...
    switch (true) {
      case lastRow.officer === '':
        errorMessage = 'Please enter Inspection Officer!';
        break;
      case lastRow.role === '':
    ...
    <ScrollView contentContainerStyle={styles.scrollViewContent} keyboardShouldPersistTaps="always">
      ...
      <View style={styles.inspectionTable}>
        <View style={styles.tableHeader}>
          <Text style={styles.headerCell}>Inspection Officer</Text>
...
export default InspectionOfficerTable;
